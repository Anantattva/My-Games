...
// @date START 2nd September, 2026
// @date END 3rd September, 2026
...
// result: very challenging, struggling & struggled hell with getting it right
...
fn main() {
    ...
    estimate_best_shot(&mut board); // hell fast: about 120ms;
}
