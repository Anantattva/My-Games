...
| 4 | **JavaScript (Web Worker, JIT Optimized)** | **420ms** | Multi-threaded (Hardware Concurrency) |
| 5 | **LuaJIT (4 Cores)** | **530ms** | Multi-threaded (4 Cores) |
| 6 | **JavaScript (Hand-Tuned, JIT Optimized)** | **830ms** | Single-threaded (V8 Optimized) |
| 7 | **LuaJIT (Single-Threaded)** | **1,100ms** (1.1s) | Single-threaded JIT |
| 8 | **JavaScript (Hand-Tuned, Pre-Warm)** | **1,100ms** (1.1s) | Single-threaded |
| 9 | **WebGPU (WGSL)** | **1,800ms** (1.8s) | GPU Compute Shader |
| 10 | **Python (Pure CPython)** | **30,000ms** (30s) | Single-threaded |
| 11 | **Python (Numpy + 4 Cores)** | **46,000ms** (46s) | Multi-threaded Vectorized |
| 12 | **Python (Baseline)** | **90,000ms** (90s) | Single-threaded Naive |
| ❌ | **JavaScript (Naive / Deleted)** | **5,000ms** (5s) | Single-threaded Naive |
